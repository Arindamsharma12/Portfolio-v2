...
const HomeScreen = () => {
  return (
    <main className="relative w-full bg-[#F9F9F9] font-sans">
      ...
      <div className="relative z-10 flex min-h-screen w-full items-start lg:items-center justify-center pointer-events-none px-6 lg:px-8 pt-12 lg:py-0 overflow-hidden">
